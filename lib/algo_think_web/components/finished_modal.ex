      ...
      <div class={[
        ...
        <div class="flex justify-center items-center w-full h-full">
          <div class="max-w-3/10 bg-white rounded-md p-6 flex flex-col justify-center items-center gap-2">
            ...
            <span class="text-md font-medium">Your User ID: <b><%= @user_id %></b></span>
            <a href={"https://docs.google.com/forms/d/e/1FAIpQLSeDLygkTAz_wiflWL4xm6-nr6ItXaTIfBVgLEfmqNRtKIbyPA/viewform?usp=pp_url&entry.2130834201=#{@user_id}"} target="_blank">
