defmodule AlgoThinkWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      class={[
        ...
        @kind == :warning && "bg-orange-50 text-orange-800 ring-orange-500 fill-orange-900",
  ...
  def table(assigns) do
    ...
    <div class="overflow-y-auto px-4 sm:overflow-visible sm:px-0">
      <table class="w-[40rem] mt-11 sm:w-full">
        ...
        >
          <%= if length(Enum.to_list(@rows)) > 0 do %>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AlgoThinkWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AlgoThinkWeb.Gettext, "errors", msg, opts)
    end
  end
