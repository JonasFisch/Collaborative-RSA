defmodule AlgoThink.Accounts.User do
  ...
  defp validate_name(changeset, _opts) do
    ...
    |> validate_length(:name, min: 1, max: 10, message: "maximum of 10 characters allowed")
  end
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, AlgoThink.Repo)
  ...
  """
  def valid_password?(%AlgoThink.Accounts.User{hashed_password: hashed_password}, password)
